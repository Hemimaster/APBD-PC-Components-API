...
namespace APBD_PC_Components_API.Migrations
{
    ...
    [Migration("20260521175444_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBD_PC_Components_API.Entities.Component", b =>
                {
            ...
            modelBuilder.Entity("APBD_PC_Components_API.Entities.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_PC_Components_API.Entities.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_PC_Components_API.Entities.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_PC_Components_API.Entities.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_PC_Components_API.Entities.Component", b =>
                {
                    b.HasOne("APBD_PC_Components_API.Entities.ComponentManufacturer", "ComponentManufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD_PC_Components_API.Entities.ComponentType", "ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("APBD_PC_Components_API.Entities.PCComponent", b =>
                {
                    b.HasOne("APBD_PC_Components_API.Entities.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD_PC_Components_API.Entities.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
