...
namespace APBD_PC_Components_API.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, new DateTime(2026, 3, 20, 10, 15, 0, 0, DateTimeKind.Unspecified), "Workstation Max", 3, 48, 10.800000000000001 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CPU0000001", 1, 1, "High performance desktop processor", "AMD Ryzen 7 7800X3D" },
                    { "GPU0000001", 2, 2, "Graphics card for gaming and creative workloads", "NVIDIA GeForce RTX 4070" },
                    { "RAM0000001", 3, 3, "DDR5 memory kit for desktop computers", "Corsair Vengeance 32GB DDR5" }
                });
